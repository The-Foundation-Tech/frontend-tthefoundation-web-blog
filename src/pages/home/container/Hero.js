...
const Hero = () => {
  return (
    <section className="container mt-32 px-3 py-5 lg:py-1 mx-auto">
      <div className="grid lg:grid-cols-2 items-center justify-items-center">
        <div className="order-2 lg:order-1 flex flex-col justify-center items-center mx-2 md:ml-10">
          <p className="text-center text-xl font-bold md:text-3xl text-customRed mt-10 border-b-2 border-customRed ">Yayasan Munsashoroh Indonesia</p>
