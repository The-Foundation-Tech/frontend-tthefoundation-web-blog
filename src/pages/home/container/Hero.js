...
const Hero = () => {
  return (
    <section>
      <div className="container md:mt-32 mt-20 px-3 py-5 lg:py-1 mx-auto">
        <div className="grid lg:grid-cols-2 items-center justify-items-center">
          <div className="order-2 lg:order-1 flex flex-col justify-center items-center mx-2 md:ml-10">
            <p className="w-full text-center text-lg font-bold md:text-3xl text-customGray mt-10">Yayasan Munsashoroh Indonesia</p>
          ...
          <div className="order-1 lg:order-2">
            <img className="rounded-xl border-2 border-white h-80 w-80 object-cover lg:w-[400px] lg:h-[400px] hover:scale-110 transition duration-500" src={images.Hero} />
          </div>
        </div>
      </div>
    </section>
