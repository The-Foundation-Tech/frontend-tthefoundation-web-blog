...
const Program = () => {
  return (
    <section className="mt-10 py-10 bg-customGray">
      <h1 className="text-3xl font-semibold text-customGray w-fit px-7 h-10 mx-auto py-auto bg-customNavy shadow-md rounded-full">Program</h1>
      ...
      <div className="container h-full flex flex-wrap justify-center mt-10 mx-auto ">
